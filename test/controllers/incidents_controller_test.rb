...
class IncidentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create incident" do
    assert_difference("Incident.count") do
      post incidents_url, params: { incident: { description: @incident.description, incident_date: @incident.incident_date, summary: @incident.summary, user_normal_id: @incident.user_normal_id } }
    end
  ...
  test "should update incident" do
    patch incident_url(@incident), params: { incident: { description: @incident.description, incident_date: @incident.incident_date, summary: @incident.summary, user_normal_id: @incident.user_normal_id } }
